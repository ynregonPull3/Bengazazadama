...
local Hackz = Instance.new("Frame")
local TextButton = Instance.new("TextButton")
local TextButton_2 = Instance.new("TextButton")
local TextButton_3 = Instance.new("TextButton")
local TextLabel = Instance.new("TextLabel")
local local_gas_station = Instance.new("ImageButton")
...
Hackz.Name = "Hackz"
Hackz.Parent = New
Hackz.BackgroundColor3 = Color3.fromRGB(63, 63, 63)
Hackz.BorderColor3 = Color3.fromRGB(60, 11, 255)
Hackz.BorderSizePixel = 4
Hackz.Position = UDim2.new(0.0541427433, 0, 0.415658087, 0)
Hackz.Size = UDim2.new(0, 396, 0, 138)
Hackz.Active = true
Hackz.Draggable = true

TextButton.Parent = Hackz
TextButton.BackgroundColor3 = Color3.fromRGB(140, 25, 255)
TextButton.BorderColor3 = Color3.fromRGB(60, 11, 255)
TextButton.BorderSizePixel = 2
TextButton.Position = UDim2.new(0.382786155, 0, 0.44082132, 0)
TextButton.Size = UDim2.new(0, 69, 0, 77)
TextButton.Font = Enum.Font.SourceSansItalic
TextButton.Text = "🥃"
TextButton.TextColor3 = Color3.fromRGB(0, 0, 0)
TextButton.TextSize = 74.000
...
TextButton_2.Parent = Hackz
TextButton_2.BackgroundColor3 = Color3.fromRGB(140, 25, 255)
TextButton_2.BorderColor3 = Color3.fromRGB(60, 11, 255)
TextButton_2.BorderSizePixel = 2
TextButton_2.Position = UDim2.new(0.555766106, 0, 0.44082129, 0)
TextButton_2.Size = UDim2.new(0, 69, 0, 77)
TextButton_2.Font = Enum.Font.SourceSansItalic
TextButton_2.Text = "🍵"
TextButton_2.TextColor3 = Color3.fromRGB(0, 0, 0)
TextButton_2.TextSize = 54.000
TextButton_2.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Aurelius0863/TeaHub/main/Loader.lua"))()
end)


TextButton_3.Parent = Hackz
TextButton_3.BackgroundColor3 = Color3.fromRGB(140, 25, 255)
TextButton_3.BorderColor3 = Color3.fromRGB(60, 11, 255)
TextButton_3.BorderSizePixel = 2
TextButton_3.Position = UDim2.new(0.207281262, 0, 0.44082132, 0)
TextButton_3.Size = UDim2.new(0, 69, 0, 77)
TextButton_3.Font = Enum.Font.SourceSansItalic
TextButton_3.Text = "🍹"
TextButton_3.TextColor3 = Color3.fromRGB(0, 0, 0)
TextButton_3.TextSize = 72.000
...
TextLabel.Parent = Hackz
TextLabel.BackgroundColor3 = Color3.fromRGB(63, 63, 63)
TextLabel.BorderColor3 = Color3.fromRGB(63, 63, 63)
TextLabel.Size = UDim2.new(0, 200, 0, 28)
TextLabel.Font = Enum.Font.SourceSansItalic
TextLabel.Text = "é un mafioso 🥃"
TextLabel.TextColor3 = Color3.fromRGB(0, 0, 0)
TextLabel.TextSize = 27.000

local_gas_station.Name = "local_gas_station"
local_gas_station.Parent = Hackz
local_gas_station.BackgroundTransparency = 1.000
local_gas_station.LayoutOrder = 17
local_gas_station.Position = UDim2.new(0.914141417, 0, 0.043478258, 0)
local_gas_station.Size = UDim2.new(0, 34, 0, 35)
local_gas_station.ZIndex = 2
local_gas_station.Image = "rbxassetid://3926305904"
local_gas_station.ImageRectOffset = Vector2.new(844, 484)
local_gas_station.ImageRectSize = Vector2.new(36, 36)
